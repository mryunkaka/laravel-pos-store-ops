        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                    <div>
                        <h4 class="mb-3">Daftar Piutang Tertunda</h4>
                        <p class="mb-0">Daftar order dengan sisa piutang yang belum lunas.</p>
                    </div>
                    <div>
                            ...
                            <table class="table mb-0">
                                <thead class="bg-white text-uppercase">
                                    <tr class="ligth ligth-data">
                                        ...
                                        <th>Pembayaran</th>
                                        <th><x-sort-link name="pay_amount" label="Dibayar" /></th>
                                        <th><x-sort-link name="due_amount" label="Piutang" /></th>
                                        <th>Aksi</th>
                                    </tr>
                                </thead>
                                <tbody class="ligth-body">
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="8" class="text-center">Tidak ada piutang tertunda ditemukan.</td>
                                        </tr>
                                    @endforelse
                                </tbody>
                            </table>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Bayar Sisa Piutang</h5>
                ...
                <form action="{{ route('order.updateDue') }}" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="due_amount">Jumlah Bayar</label>
