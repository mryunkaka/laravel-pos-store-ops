            ...
            <div class="col-lg-12">
                ...
                <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                    <div>
                        ...
                        <p class="mb-0">
                            Kelola kategori produk Anda secara efektif untuk meningkatkan organisasi <br>
                            dan navigasi pelanggan.
                        </p>
                    </div>
                    <div class="d-flex align-items-center">
                        <a href="{{ route('categories.create') }}" class="btn btn-primary add-list d-flex align-items-center mr-3">
                            <x-heroicon-o-plus class="w-5 h-5 mr-1" /> Tambah Kategori
                        </a>
                            ...
                            @empty
                                <tr>
                                    <td colspan="5" class="text-center">
                                        <span class="text-muted">Tidak ada kategori ditemukan. Klik "Tambah Kategori" untuk menambahkan.</span>
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
