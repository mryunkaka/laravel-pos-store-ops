                        ...
                        <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" class="form-control @error('print_size') is-invalid @enderror" id="print_size" name="print_size" value="{{ old('print_size') }}" placeholder="Contoh: 3 X 1 M">
                                    @error('print_size')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" class="form-control @error('print_notes') is-invalid @enderror" id="print_notes" name="print_notes" value="{{ old('print_notes') }}">
                                    @error('print_notes')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
