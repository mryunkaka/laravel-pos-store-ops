                    ...
                    <table class="table mb-0">
                        <thead class="bg-white text-uppercase">
                            <tr class="ligth ligth-data">
                                <th>No.</th>
                                <th><x-sort-link name="date" label="Tanggal" /></th>
                                <th>Aksi</th>
                            </tr>
                        </thead>
                        <tbody class="ligth-body">
                            ...
                            @empty
                                <tr>
                                    <td colspan="3" class="text-center text-muted">Belum ada data absensi. Klik "Buat Absensi" untuk menambah data baru.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
