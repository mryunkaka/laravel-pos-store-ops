...
- PC konsumen memakai folder runtime tanpa versi: `C:\Server\nginx`, `C:\Server\nssm`, dan `C:\Server\php`.
...
- Default repair memakai service `pos3-web`; fallback proses hanya dipakai jika service tersebut tidak terdaftar, sehingga reload tidak lagi ditolak karena Nginx aktif di bawah konteks service berbeda.
